...
<style> 
            body { 
                background-image: url("../img/nuevotuxi.gif"); 
                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  id="rol" name="rol" class="form-control" placeholder="Escribe el rol, 1=Maestro, 2=Jefe de carrera, 3=Alumno">
